...
export const meta = {
  ...
  lastEdited: '2019-04-25T12:28:30.000Z'
}
...
Using these credentials, you should connect to your database and insert the [example data](https://github.com/zeit/now-examples/blob/add/next-mysql/nextjs-mysql/db.sql) into a new table. This guide does not cover inserting records into a MySQL database, more information on doing this can be found in the [MySQL documentation](https://dev.mysql.com/doc/mysql-getting-started/en/#mysql-getting-started-connecting).
...
<Note>
  ...
  <GenericLink href="https://github.com/zeit/now-examples/blob/add/next-mysql/nextjs-mysql/pages/index.js">
    example repository
  </GenericLink>
  .
</Note>
...
<Note>
  This is an extract, the full code for this file can be found in the{' '}
  <GenericLink href="https://github.com/zeit/now-examples/blob/add/next-mysql/nextjs-mysql/pages/profile.js">
    example repository
  </GenericLink>
  .
</Note>
